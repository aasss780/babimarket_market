...
<head>
    ...
    <title>BabiMarket - Forgot Password</title>
    ...
    <style>
        ...
        * { margin:0; padding:0; box-sizing:border-box; font-family:'Poppins',sans-serif; }
        ...
        .welcome-text p { font-size:14px; color:var(--text-gray); margin-bottom:20px; line-height:1.5; }
        ...
        .btn-primary { width:100%; padding:14px; background-color:var(--primary); color:white; border:none; border-radius:10px; font-size:15px; font-weight:700; cursor:pointer; transition:0.3s; margin-bottom:16px; }
...
<body>
    <div class="login-card">
        ...
        <div class="welcome-text">
            ...
            <p>Enter the email for your account. If it exists, you can set a new password on the next step.</p>
        </div>
        <div class="demo-note"><i class="fa-solid fa-circle-info" style="color:var(--primary);"></i> <strong>Demo:</strong> No email is sent. Reset does not use a secure token—local internship use only.</div>
        @if($errors->any())
            <div class="error-box">
